                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{route('services.update',$service)}}">
                                @csrf
                                @method('PUT')
                                <x-c-input type="text" label="Nom:" name="name" id="name" value="{{$service->name}}"/>
                                <x-c-input type="text" label="Nom en arabe :" name="name_ar" id="name_ar" value="{{$service->name_ar}}"/>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="type" @checked($service->type == "S") id="S" value="S">
                                    <label class="form-check-label" for="S">Service</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="type" @checked($service->type == "A") id="A" value="A">
