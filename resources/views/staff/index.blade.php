                ...
                <div class="col">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            ...
                            <a href="Instructor.Detail.html" class="body-link">{{$staff['first_name'] . ' ' . $staff['last_name']}}</a>
                            ...
                            <div class="row g-0 align-items-center mb-1">
                                ...
                                <div class="col ps-3">
                                    <div class="sh-4 d-flex align-items-center lh-1-25">{{$staff->email ?? "Vide"}}</div>
                                </div>
                            </div>
                            <div class="row g-0 align-items-center mb-1">
                                <div class="col-auto">
                                ...
                                <div class="col ps-3">
                                    <div class="sh-4 d-flex align-items-center lh-1-25">{{$staff->phone ?? "Vide"}}</div>
                                </div>
                            </div>
