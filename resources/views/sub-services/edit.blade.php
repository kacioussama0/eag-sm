        ...
        <div class="row mb-n5">
            ...
            <div class="col-xl-4">
                <div class="mb-5">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{route('sub-services.update',$subService)}}">
                                @csrf
                                @method('PUT')
                                <x-c-input type="text" label="Nom:" name="name" id="name" value="{{$subService->name}}"/>
                                <x-c-input type="text" label="Nom en arabe :" name="name_ar" id="name_ar" value="{{$subService->name_ar}}"/>
                                <x-c-select label="Service : " name="service_id" :options="$services" value="{{$subService->service_id}}"/>
