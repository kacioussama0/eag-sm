        ...
        <!-- Title and Top Buttons End -->
            ...
            <div class="row mb-n5">
                    ...
                    <div class="col-xl-4">
                        <div class="mb-5">
                            <x-alert />
                            <h2 class="small-title">Ajout de Cycle</h2>
                            <div class="card">
                                <div class="card-body">
                                    <form method="POST" action="{{route('cycles.store')}}" enctype="multipart/form-data">
                                        @csrf
                                        <x-c-input type="text" label="Nom du cycle: " name="name" id="name" value="{{old('name')}}"/>
                                        <x-c-input type="text" label="Nom du cycle en arabe :" name="name_ar" id="name_ar" value="{{old('name_ar')}}"/>
                                        <x-c-input type="number" label="Durée: " name="duration" id="duration" value="{{old('duration')}}"/>
