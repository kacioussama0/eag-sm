                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{route('branches.update',$branch)}}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <x-c-select label="Cycle: " name="cycle_id" :options="$cycles" value="{{$branch->cycle_id}}"/>
                                <x-c-input type="text" label="Code :" name="code_branch" id="name" value="{{$branch->code_branch}}"/>
                                <x-c-input type="text" label="Nom de la branche :" name="name" id="name" value="{{$branch->name}}"/>
                                <x-c-input type="text" label="Nom de la branche en arabe :" name="name_ar" id="name_ar" value="{{$branch->name_ar}}"/>
