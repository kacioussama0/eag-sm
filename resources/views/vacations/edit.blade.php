                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{route('vacations.update',$vacation)}}">
                                @csrf
                                @method('PUT')
                                <x-c-select label="Employé : " name="staff_id" :options="$staffs" value="{{$vacation->staff_id}}" />
                                <x-c-input type="date" label="Date: " name="start_date" id="start_date" value="{{$vacation->start_date}}"/>
                                <x-c-input type="date" label="Fin : " name="end_date" id="end_date" value="{{$vacation->end_date}}"/>
                                <x-c-select label="Type : " name="type_vacation_id" :options="$vacationType" value="{{$vacation->type_vacation_id}}" />
